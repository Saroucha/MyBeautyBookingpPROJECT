...
public class Profile_Pro extends AppCompatActivity {
    ...
    private int TRACK = 0;
    int success;
    public  String HttpUrlDeleteRecord = "http://192.168.43.103/ProjetClient2/MyBeautyBookingServer-master/deletePro.php";
    public  String URL_EDIT = "http://192.168.43.103/ProjetClient2/MyBeautyBookingServer-master/UpdatePro.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        distance.setText(preferenceHelper.getDistance()+ "km de cette ville");
    ...
    private class DeleteMovieAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog2.setMessage("Suppression du compte. Patientez...");
                ...
                public void run() {
                    if (success == 1) {
                        ...
                        Toast.makeText(Profile_Pro.this,
                                "Compte supprimé", Toast.LENGTH_LONG).show();
                        Intent i = getIntent();
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(success.equals("1")){
                                Toast.makeText(Profile_Pro.this,"succée",Toast.LENGTH_SHORT).show();
    ...
    public void save(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String FinalData = imageProcessClass.ImageHttpRequest("http://10.192.128.139/ProjetClient2/MyBeautyBookingServer-master/UpdatePro.php", HashMapParams);
