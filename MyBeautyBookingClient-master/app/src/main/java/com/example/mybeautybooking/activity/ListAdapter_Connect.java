...
public class ListAdapter_Connect extends RecyclerView.Adapter{
    ...
    public ListAdapter_Connect(ArrayList<Professionnel> Ap)
    {this.Ap=Ap;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ListAdapter_Connect.ListViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ((ListAdapter_Connect.ListViewHolder) holder).bindView(position);
    }
    @Override
    ...
    private class ListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void bindView(int position){
            String s ;
            s = Ap.get(position).getNomEntreprise();
